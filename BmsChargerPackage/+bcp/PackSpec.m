...
%     not have to guess.
    ...
    properties (Dependent)
        ...
        I_term_A    % pack charge termination current [A]
        I_dch_A     % pack continuous discharge current [A]
        I_dch_pulse_A % pack short-pulse discharge current [A]
        P_dch_W     % continuous discharge power at nominal voltage [W]
        P_dch_pulse_W % short-pulse discharge power at nominal voltage [W]
    ...
    methods
        ...
        function v = get.I_term_A(obj),    v = obj.Cell.I_term_A * obj.P;      end
        function v = get.I_dch_A(obj),     v = obj.Cell.I_dch_cont_A * obj.P;  end
        function v = get.I_dch_pulse_A(obj), v = obj.Cell.I_dch_pulse_A * obj.P; end
        function v = get.P_dch_W(obj),     v = obj.I_dch_A * obj.V_nom;        end
        function v = get.P_dch_pulse_W(obj), v = obj.I_dch_pulse_A * obj.V_nom; end
        ...
        %SUMMARY  One printable block of the pack numbers the charger needs.
            s = sprintf([ ...
                ...
                '  charge        %.1f A standard (%.2fC),  %.1f A maximum (%.2fC)\n' ...
                '  discharge     %.0f A continuous (%.0f W),  %.0f A pulse (%.0f W)\n'], ...
                obj.Cell.Name, obj.S, obj.P, obj.NCells, ...
                obj.Q_Ah, obj.Wh, ...
                obj.V_nom, obj.V_max, obj.V_min, ...
                obj.R_dc_Ohm*1000, ...
                obj.I_chg_std_A, obj.Cell.C_rate_chg(), ...
                obj.I_chg_max_A, obj.Cell.C_rate_chg_max(), ...
                obj.I_dch_A, obj.P_dch_W, ...
                obj.I_dch_pulse_A, obj.P_dch_pulse_W);
        end
