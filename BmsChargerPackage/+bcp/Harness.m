...
'%%  current array is CHARGE-positive -- both matching what a Battery Model\n' ...
'%%  Builder pack hands you, so that a sign or layout mistake in the default\n' ...
'%%  configuration surfaces here rather than in your real model.\n' ...
'\n' ...
'P = %s;\n' ...
'\n' ...
